...
# ---------------------------
genai.configure(api_key="AIzaSyCo-5gX8n9mtrq5D3Gv5lNrAGrmpP56-O4")

# Google Maps API Key
GOOGLE_MAPS_API_KEY = "AIzaSyCyoR1pqye_p7gUXSp4iFocu39_nvgP5ko"
...
def get_user_location():
    """Fetches accurate user location using Google Geolocation API"""
    gmaps = googlemaps.Client(key=GOOGLE_MAPS_API_KEY)
